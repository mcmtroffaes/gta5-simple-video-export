...
public:
	...
	AudioStream(std::shared_ptr<AVFormatContext>& format_context, AVCodecID codec_id, AVDictionary** options, AVSampleFormat sample_fmt, int sample_rate, uint64_t channel_layout);
