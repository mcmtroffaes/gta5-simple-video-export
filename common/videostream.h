...
public:
	...
	VideoStream(std::shared_ptr<AVFormatContext>& format_context, AVCodecID codec_id, const AVDictionaryPtr& options, int width, int height, const AVRational& frame_rate, AVPixelFormat pix_fmt);
